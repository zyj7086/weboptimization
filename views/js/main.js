...
//take this variable outside of for loop , it won't call the Dom everytime it runs .
...
// replaced querySelectorAll with getElementsByClassName , it never changes , so put it outside .
var items = document.getElementsByClassName('mover');

function updatePositions() {
  frame++;
  window.performance.mark("mark_start_frame");
//This var calculates the scrollTop before the loop ,
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // create variables to store those two nodes
  ...
  for (var i = 0; i < 34; i++) {
    ...
    // update this append without a query
